...
def industry_split(photo_src, alt, label, title, body_html, positions):
    """Large photo + copy split used for each industry's overview section."""
    return f"""
<section>
...
INDUSTRY_PHOTOS = {
    "technology": ("industries-technology.jpg", "A technology professional troubleshooting a system for Southern Point"),
    "healthcare": ("industries-healthcare.jpg", "Healthcare administrative and operational staff at work for Southern Point"),
    "sales": ("industries-sales.jpg", "A sales and account-management conversation Southern Point staffs for"),
    "operations": ("industries-operations.jpg", "Operations and coordination work Southern Point staffs for"),
    "administrative": ("industries-administrative.jpg", "Front-office and administrative support Southern Point staffs for"),
}

for ind in INDUSTRIES:
    photo_src, photo_alt = INDUSTRY_PHOTOS[ind["slug"]]
