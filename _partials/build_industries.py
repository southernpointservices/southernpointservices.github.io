...
<div>
<div class="section-label">INDUSTRY OVERVIEW</div>
<h2 class="section-title">Staffing built around {ind['name'].lower()} work.</h2>
<p class="section-intro">{ind['overview']}</p>
<h3 style="margin-top:34px; font-size:18px;">Positions Southern Point commonly staffs</h3>
<ul class="role-list">
{positions_html(ind['positions'])}
</ul>
</div>
<div class="visual-panel">
<div class="visual-panel-mark">{ind['name']}<br>Staffing</div>
</div>
</div>
</section>
...
<div class="grid-3">
{challenges_html(ind['challenges'])}
</div>
</div>
</section>
...
<section class="tint">
<div class="container dual-cta">
<div class="card">
<div class="section-label">FOR EMPLOYERS</div>
<h3 style="margin-top:0;">Need {ind['name']} Talent?</h3>
<p>Tell Southern Point about your hiring need and we'll follow up to discuss next steps.</p>
<a class="btn" href="/request-talent/" style="margin-top:18px;">Request Talent</a>
</div>
<div class="card">
<div class="section-label">FOR JOB SEEKERS</div>
<h3 style="margin-top:0;">Looking for {ind['name']} Work?</h3>
<p>Explore current openings or submit your resume for consideration on future roles.</p>
<a class="btn btn-outline" href="/jobs.html?category={ind['name']}" style="margin-top:18px;">Find Opportunities</a>
</div>
</div>
</section>
"""
