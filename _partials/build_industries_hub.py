...
<div class="stats" style="margin-top:36px; padding-top:30px; border-top:1px solid var(--sp-line-dark);">
<div class="stat"><strong>Five Focus Areas</strong><span>Depth, not shallow reach</span></div>
<div class="stat"><strong>Plus Public Sector</strong><span>Via Government Contracting</span></div>
...
<section class="tint">
<div class="container">
<div class="section-label">BEYOND THE FIVE FOCUS AREAS</div>
<h2 class="section-title" style="max-width:760px;">Broader reach through Government Contracting.</h2>
<p class="section-intro">Alongside its five focus industries, Southern Point pursues public-sector opportunities that touch adjacent categories — infrastructure, professional services, and logistics support among them — coordinated through its government contracting capability rather than as separate staffing verticals.</p>
<a class="btn btn-outline" href="/government-contracting/" style="margin-top:16px;">Explore Government Contracting</a>
</div>
</section>
