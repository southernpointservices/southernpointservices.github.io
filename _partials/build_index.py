...
STYLE = """
/* =========================
   HERO — large typography, real photography, no boxed panel
========================= */
.hero-shell{
    position:relative;
...
@media(max-width:980px){
    ...
    .hero-copy{padding:160px 24px 50px;}
    .hero-photo{min-height:320px;}
}

/* =========================
   LARGE PHOTO + STATEMENT
========================= */
.photo-statement-frame{
    width:100%;
    aspect-ratio:2/1;
}

@media(max-width:700px){
    .photo-statement-frame{aspect-ratio:4/3;}
}
...
<img class="photo" src="/assets/images/hero-workforce.jpg" alt="Southern Point professionals collaborating in a modern workplace">
</div>
...
<section class="tint">
<div class="container">
<div class="photo-frame photo-statement-frame" style="margin-bottom:44px;">
<img class="photo" src="/assets/images/homepage-brand.jpg" alt="Organizations at work across Southern Point's focus industries">
</div>
...
<img class="photo" src="/assets/images/homepage-employers.jpg" alt="An organization reviewing a hiring need with Southern Point">
</div>
<div>
