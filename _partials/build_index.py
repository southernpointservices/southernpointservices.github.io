...
def pillar_blocks():
    out = []
    for num, eyebrow, headline, copy, tags, cta_label, cta_href in PILLARS:
...
<a class="btn btn-outline-white" href="/services/">Explore Our Services</a>
</div>
...
<div class="visual-panel-mark">FIND<br>TALENT</div>
</div>
<div>
