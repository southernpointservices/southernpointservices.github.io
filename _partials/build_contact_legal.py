...
.help-option.active{
    ...
    padding:23px 21px;
    background:#ffffff;
    box-shadow:inset 0 0 0 1px var(--sp-bronze-dark);
}
...
<strong>Email</strong>
<a href="mailto:contact@southernpointllc.com">contact@southernpointllc.com</a>
</div>
<div class="contact-info-item">
...
<h2>Contact</h2>
<p>Questions about this Privacy Policy can be sent to <a href="mailto:contact@southernpointllc.com">contact@southernpointllc.com</a>.</p>
</div>
</div>
</section>
"""
...
<h2>Contact</h2>
<p>Questions about these Terms of Use can be sent to <a href="mailto:contact@southernpointllc.com">contact@southernpointllc.com</a>.</p>
</div>
</div>
</section>
"""
...
<h2>Contact</h2>
<p>Accessibility feedback can be sent to <a href="mailto:contact@southernpointllc.com">contact@southernpointllc.com</a>. Please describe the issue and the page you were trying to use, and we will follow up.</p>
</div>
</div>
</section>
"""
