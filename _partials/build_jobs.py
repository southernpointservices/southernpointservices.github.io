...
<form class="notify-form" action="https://formsubmit.co/contact@southernpointllc.com" method="POST">
...
<form id="applyForm" action="https://formsubmit.co/contact@southernpointllc.com" method="POST" enctype="multipart/form-data">
